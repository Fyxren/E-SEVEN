<footer class="pb-10 footer footer-center">
	<div>
		<div class="flex items-center gap-5">
			<img src="/logo-stroke.svg" alt="logo" class="h-12" />
			<p class="text-4xl">E-SEVEN</p>
		</div>
		<p class="mt-2 text-lg">Muziek voor bruiloften en andere evenementen.</p>
	</div>
	<div>
		<div class="grid grid-flow-col gap-4">
			...
			<a target="_blank" href="mailto:esevenband@gmail.com">
				<svg class="duration-300 fill-current hover:fill-primary" width="40" height="40" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
					<path
