<main class="my-10">
	...
	<p class="mt-2 text-center md:mt-10 md:text-lg">
		Voor meer informatie zit je hier op de jusite plek, kies de gewenste methode voor contact:
	</p>
	<div class="flex flex-col justify-center gap-5 py-10 pb-10 md:pb-20 md:flex-row md:gap-10">
		<a class="self-center btn btn-wide btn-primary" href="mailto:esevenband@gmail.com">
			<svg
